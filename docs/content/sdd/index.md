...
This section records decisions about how we *work* on this repo — not
the system architecture itself (see [Architecture](../architecture.md)),
but the process and tooling choices behind it. First entry: how we
approached `AGENTS.md`.
